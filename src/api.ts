...
export class OpenSeaAPI {
  ...
  /**
	 ...
	 */
  public async getAssets(query: OpenSeaAssetQuery = {}, page = 1): Promise<{ assets: OpenSeaAsset[]; estimatedCount: number }> {
  ...
  /**
	 ...
	 * @param retries Number of times to retry if the service is unavailable for any reason
	 */
  public async getPaymentTokens(query: OpenSeaFungibleTokenQuery = {}, page = 1, retries = 1): Promise<{ tokens: OpenSeaFungibleToken[] }> {
    let json
    try {
  ...
  /**
	 ...
	 */
  public async getBundles(query: OpenSeaAssetBundleQuery = {}, page = 1): Promise<{ bundles: OpenSeaAssetBundle[]; estimatedCount: number }> {
