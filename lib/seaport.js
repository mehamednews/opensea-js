...
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        var readonlyProvider = new Web3.providers.HttpProvider("".concat(this.api.apiBaseUrl, "/").concat(constants_1.RPC_URL_PATH));
        // Web3 Config
        ...
        this._wrappedNFTLiquidationProxyAddress =
            this._networkName == types_1.Network.Main ? constants_1.WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_MAINNET : constants_1.WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_RINKEBY;
    ...
    OpenSeaPort.prototype.addListener = function (event, listener, once) {
        ...
        var subscription = once ? this._emitter.once(event, listener) : this._emitter.addListener(event, listener);
        return subscription;
    };
    /**
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, utils_1.sendRawTransaction)(this.web3, {
                                ...
                                value: 0,
                                data: (0, schema_1.encodeCall)((0, contracts_1.getMethod)(contracts_1.WrappedNFTLiquidationProxy, 'wrapNFTs'), [tokenIds, tokenAddresses, isMixedBatchOfAssets]),
                            }, function (error) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, utils_1.sendRawTransaction)(this.web3, {
                                ...
                                to: this._wrappedNFTLiquidationProxyAddress,
                                value: 0,
                                data: (0, schema_1.encodeCall)((0, contracts_1.getMethod)(contracts_1.WrappedNFTLiquidationProxy, 'unwrapNFTs'), [tokenIds, tokenAddresses, destinationAddresses, isMixedBatchOfAssets]),
                            }, function (error) {
                                _this._dispatch(types_1.EventType.TransactionDenied, { error: error, accountAddress: accountAddress });
                            })];
                    case 1:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, utils_1.sendRawTransaction)(this.web3, {
                                ...
                                to: token.address,
                                value: 0,
                                data: (0, schema_1.encodeCall)((0, contracts_1.getMethod)(contracts_1.CanonicalWETH, 'withdraw'), [amount.toString()]),
                            }, function (error) {
                                _this._dispatch(types_1.EventType.TransactionDenied, { error: error, accountAddress: accountAddress });
                            })];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.cancelOrder_.sendTransactionAsync([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [
                ...
                switch (_e.label) {
                    ...
                    case 9:
                        ...
                        approvalOneCheck = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, utils_1.promisifyCall)(function (c) { return contract.getApproved.call(tokenId, c); })];
                                    case 1:
    ...
    OpenSeaPort.prototype.getCurrentPrice = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.calculateCurrentPrice_.callAsync([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [
                            order.makerRelayerFee,
                            order.takerRelayerFee,
                            order.makerProtocolFee,
                            order.takerProtocolFee,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        quantityBN = quantity ? wyvern_js_1.WyvernProtocol.toBaseUnitAmount((0, utils_1.makeBigNumber)(quantity), asset.decimals || 0) : (0, utils_1.makeBigNumber)(1);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        isOldNFT = isCryptoKitties || (!!asset.version && [types_1.TokenStandardVersion.ERC721v1, types_1.TokenStandardVersion.ERC721v2].includes(asset.version));
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        offlineTokens = __spreadArray([tokenSettings.canonicalWrappedEther], tokenSettings.otherTokens, true).filter(function (t) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, utils_1.promisifyCall)(function (c) {
                                var _a;
                                return (_a = contract_1[abi_1.name]).call.apply(_a, __spreadArray(__spreadArray([accountAddress], inputValues_1, false), [c], false));
                            })];
                    case 1:
                        count = _b.sent();
                        if (count !== undefined) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, utils_1.promisifyCall)(function (c) {
                                var _a;
                                return (_a = contract_2[abi_2.name]).call.apply(_a, __spreadArray(__spreadArray([], inputValues_2, false), [c], false));
                            })];
                    case 3:
                        owner = _b.sent();
                        if (owner) {
                            return [2 /*return*/, owner.toLowerCase() == accountAddress.toLowerCase() ? new bignumber_js_1.BigNumber(1) : new bignumber_js_1.BigNumber(0)];
                        }
                        return [3 /*break*/, 5];
                    case 4: 
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        transferFee = asset.transferFee ? (0, utils_1.makeBigNumber)(asset.transferFee) : transferFee;
                        transferFeeTokenAddress = asset.transferFeePaymentToken ? asset.transferFeePaymentToken.address : transferFeeTokenAddress;
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, (0, utils_1.getTransferFeeSettings)(this.web3, { asset: asset, accountAddress: accountAddress })];
                    case 2:
                        result = _c.sent();
    ...
    OpenSeaPort.prototype.validateAndPostOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.hashOrder_.callAsync([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [
                            order.makerRelayerFee,
                            order.takerRelayerFee,
                            order.makerProtocolFee,
                            order.takerProtocolFee,
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._getClientsForRead(retries).wyvernProtocol.wyvernExchange.atomicMatch_.estimateGasAsync([
                                ...
                                sell.expirationTime,
                                sell.salt,
                            ], [buy.feeMethod, buy.side, buy.saleKind, buy.howToCall, sell.feeMethod, sell.side, sell.saleKind, sell.howToCall], buy.calldata, sell.calldata, buy.replacementPattern, sell.replacementPattern, buy.staticExtradata, sell.staticExtradata, [buy.v || 0, sell.v || 0], [buy.r || constants_1.NULL_BLOCK_HASH, buy.s || constants_1.NULL_BLOCK_HASH, sell.r || constants_1.NULL_BLOCK_HASH, sell.s || constants_1.NULL_BLOCK_HASH, metadata], 
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, utils_1.rawCall)(this.web3, {
                                from: accountAddress,
                                to: tokenAddress,
                                data: (0, schema_1.encodeCall)((0, contracts_1.getMethod)(contracts_1.ERC20, 'allowance'), [accountAddress, addressToApprove]),
                            })];
                    case 1:
                        approved = _b.sent();
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        _f = (0, schema_1.encodeBuy)(schema, wyAsset, accountAddress), target = _f.target, calldata = _f.calldata, replacementPattern = _f.replacementPattern;
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 2:
                        ...
                        _d = (0, schema_1.encodeSell)(schema, wyAsset, accountAddress), target = _d.target, calldata = _d.calldata, replacementPattern = _d.replacementPattern;
                        orderSaleKind = endAmount != null && endAmount !== startAmount ? types_1.SaleKind.DutchAuction : types_1.SaleKind.FixedPrice;
    ...
    OpenSeaPort.prototype._getStaticCallTargetAndExtraData = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        isCheezeWizards = [constants_1.CHEEZE_WIZARDS_GUILD_ADDRESS.toLowerCase(), constants_1.CHEEZE_WIZARDS_GUILD_RINKEBY_ADDRESS.toLowerCase()].includes(asset.tokenAddress.toLowerCase());
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                staticTarget: isMainnet ? constants_1.STATIC_CALL_CHEEZE_WIZARDS_ADDRESS : constants_1.STATIC_CALL_CHEEZE_WIZARDS_RINKEBY_ADDRESS,
                                staticExtradata: (0, schema_1.encodeCall)((0, contracts_1.getMethod)(contracts_1.StaticCheckCheezeWizards, 'succeedIfCurrentWizardFingerprintMatchesProvidedWizardFingerprint'), [
                                    asset.tokenId,
                                    wizardFingerprint,
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, {
                                ...
                                staticExtradata: (0, schema_1.encodeCall)((0, contracts_1.getMethod)(contracts_1.StaticCheckDecentralandEstates, 'succeedIfCurrentEstateFingerprintMatchesProvidedEstateFingerprint'), [
                                    asset.tokenId,
                                    estateFingerprint,
                                    useTxnOriginStaticCall,
                                ]),
                    ...
                    case 6:
                        if (useTxnOriginStaticCall) {
                            return [2 /*return*/, {
                                    staticTarget: isMainnet ? constants_1.STATIC_CALL_TX_ORIGIN_ADDRESS : constants_1.STATIC_CALL_TX_ORIGIN_RINKEBY_ADDRESS,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        accountAddress = (0, utils_1.validateAndFormatWalletAddress)(this.web3, accountAddress);
                        quantityBNs = quantities.map(function (quantity, i) { return wyvern_js_1.WyvernProtocol.toBaseUnitAmount((0, utils_1.makeBigNumber)(quantity), assets[i].decimals || 0); });
        ...
        var computeOrderParams = function () {
            if ('asset' in order.metadata) {
                ...
                var orderedSchemas = bundle.schemas
                    ...
                    : // Backwards compat:
                        bundle.assets.map(function () { return _this._getSchema('schema' in order.metadata ? order.metadata.schema : undefined); });
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 7:
                        error_11 = _d.sent();
                        if (retries <= 0) {
                            throw new Error("Error matching this listing: ".concat(error_11.message, ". Please contact the maker or try again later!"));
                        }
                        return [4 /*yield*/, (0, utils_1.delay)(500)];
                    case 8:
                        _d.sent();
    ...
    OpenSeaPort.prototype._sellOrderValidationAndApprovals = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wyAssets = 'bundle' in order.metadata ? order.metadata.bundle.assets : order.metadata.asset ? [order.metadata.asset] : [];
                    ...
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters_.callAsync([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [
                            order.makerRelayerFee,
                            order.takerRelayerFee,
                            order.makerProtocolFee,
                            order.takerProtocolFee,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.approveOrder_.sendTransactionAsync([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [
                                order.makerRelayerFee,
                                order.takerRelayerFee,
                                order.makerProtocolFee,
                                order.takerProtocolFee,
    ...
    OpenSeaPort.prototype._validateOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrder_.callAsync([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [
                            order.makerRelayerFee,
                            order.takerRelayerFee,
                            order.makerProtocolFee,
                            order.takerProtocolFee,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        _b.sent();
                        _b.label = 5;
                    case 5: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters_.callAsync([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [
                            order.makerRelayerFee,
                            order.takerRelayerFee,
                            order.makerProtocolFee,
                            order.takerProtocolFee,
    ...
    OpenSeaPort.prototype._getBuyFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, sellOrder) {
        ...
        if (sellOrder) {
            ...
            makerRelayerFee = sellOrder.waitingForBestCounterOrder ? (0, utils_1.makeBigNumber)(sellOrder.makerRelayerFee) : (0, utils_1.makeBigNumber)(sellOrder.takerRelayerFee);
            takerRelayerFee = sellOrder.waitingForBestCounterOrder ? (0, utils_1.makeBigNumber)(sellOrder.takerRelayerFee) : (0, utils_1.makeBigNumber)(sellOrder.makerRelayerFee);
        }
        else {
    ...
    OpenSeaPort.prototype._getSellFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, waitForHighestBid, sellerBountyBasisPoints) {
        ...
        var feeRecipient = waitForHighestBid ? constants_1.NULL_ADDRESS : constants_1.OPENSEA_FEE_RECIPIENT;
        // Swap maker/taker fees when it's an English auction,
        // since these sell orders are takers not makers
        var makerRelayerFee = waitForHighestBid ? (0, utils_1.makeBigNumber)(totalBuyerFeeBasisPoints) : (0, utils_1.makeBigNumber)(totalSellerFeeBasisPoints);
        var takerRelayerFee = waitForHighestBid ? (0, utils_1.makeBigNumber)(totalSellerFeeBasisPoints) : (0, utils_1.makeBigNumber)(totalBuyerFeeBasisPoints);
        return {
            makerRelayerFee: makerRelayerFee,
            takerRelayerFee: takerRelayerFee,
            makerProtocolFee: (0, utils_1.makeBigNumber)(0),
    ...
    OpenSeaPort.prototype._validateFees = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints) {
        ...
        if (totalBuyerFeeBasisPoints > constants_1.INVERSE_BASIS_POINT || totalSellerFeeBasisPoints > constants_1.INVERSE_BASIS_POINT) {
                ...
                switch (_c.label) {
                    ...
                    case 7:
                        ...
                        args = [
                            ...
                            [buy.v || 0, sell.v || 0],
                            [buy.r || constants_1.NULL_BLOCK_HASH, buy.s || constants_1.NULL_BLOCK_HASH, sell.r || constants_1.NULL_BLOCK_HASH, sell.s || constants_1.NULL_BLOCK_HASH, metadata],
                        ];
                        _c.label = 8;
                    case 8:
                    ...
                    case 10:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"".concat(error_13.message.substr(0, debugging_1.MAX_ERROR_LENGTH), "...\""));
                    case 11:
                    ...
                    case 13:
                        ...
                        throw new Error("Failed to authorize transaction: \"".concat(error_14.message ? error_14.message : 'user denied', "...\""));
